...
describe('PrismaElectionRepository integration', () => {
  ...
  const timeAt = (hh: number, mm = 0, ss = 0): Date =>
    new Date(Date.UTC(1970, 0, 1, hh, mm, ss));
