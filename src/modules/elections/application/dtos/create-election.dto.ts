...
export class CreateElectionDto {
  ...
  @ApiProperty({ example: '15:00:00', description: 'Start time in HH:mm[:ss] format.' })
  @IsString()
  @Matches(TIME_FORMAT, {
  ...
  @ApiProperty({ example: '2026-08-30', description: 'End date in YYYY-MM-DD format.' })
  @IsString()
  @Matches(DATE_FORMAT, {
  ...
  @ApiProperty({ example: '15:00:00', description: 'End time in HH:mm[:ss] format.' })
  @IsString()
  @Matches(TIME_FORMAT, {
